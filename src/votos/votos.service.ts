...
export class VotosService {
  ...
  async distribucionListasGlobal(id_eleccion: number) {
    ...
    const [rows] = await this.db.query(
      `SELECT pa.nombre                    as nombre_partido,
